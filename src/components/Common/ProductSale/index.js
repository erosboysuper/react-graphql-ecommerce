...
const ProductSale = ({ product, vertical }) => {
  const { toggle, setModal, localeFolder, localeSetting } =
    ...
    <LazyLoad>
      <Parent>
        <Contain opacity={isSold ? 0.5 : 1}>
          ...
          {!isSold && product.isFadingOut ? (
            <TipImage>
              <Image src={FadeImg} alt="FadeImg" />
              <TipLetter
                top={103}
                topLaptop={125}
                topLaptopL={157}
          ...
          {!isSold && product.isLimitedEdition ? (
            <TipImage>
              <Image src={LimitedImg} alt="LimitedImg" />
              <TipLetter
                top={119}
                topLaptop={140}
                topLaptopL={180}
          ...
          {!isSold && product.isTboCommunity ? (
            <TipImage>
              <Image src={TboImg} alt="TboImg" />
              <TipLetter
                top={121}
                topS={111}
                topLaptop={142}
          ...
          {!isSold && product.isTboCommunity ? (
            <Order>
              ...
              &nbsp;&nbsp;
              <Image1 src={OrderImg} alt="OrderImg" />
            </Order>
          ) : !isSold ? (
            <TipImage2
              right={0}
            ...
            >
              <Image src={QuickCartImg} alt="QuickCartImg" />
            </TipImage2>
          ) : (
            ''
          )}
